...
export const options = {
  //vus: 1,
   ...
   stages: [
     { duration: '120s', target: 1100},
     { duration: '180s', target: 1100},
...
export default function () {
  ...
  let response = http.get( baseUrl + `/cloudloyalty/v2/showcases/familhao/5?pageSize=10&pageIndex=-1&sort=RELEVANCE&useSegments=False&showOlnySegmentsProducts=False` , params,)
  check(response, {
